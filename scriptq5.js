...
const tooltip = d3.select("#tooltip-q5");
...
d3.csv("data/data.csv").then(rawData => {
  ...
  const nestedData = d3.rollups(
    ...
    v => {
      ...
      return {
        doanhThuTrungBinh: soNgayXuatHien > 0 ? doanhThuTong / soNgayXuatHien : 0,
        skuTrungBinh: soNgayXuatHien > 0 ? skuTong / soNgayXuatHien : 0,
